...
if (!empty($orderIds)) {
    foreach ($orderIds as $orderId) {
        ...
        $actionData = json_encode([
            ...
            "seller_user_id" => (int)$orderRow['seller_user_id'],
        ...
        <div class="form-card" style="max-width: 900px;">
            ...
            <div class="receipt-card">
                ...
                <div class="receipt-note">
                    <strong>Important:</strong> If a negotiated offer was accepted, the paid unit price reflects that accepted offer amount.
                </div>
            </div>
